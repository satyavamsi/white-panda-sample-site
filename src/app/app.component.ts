...
export class AppComponent implements OnInit{
  ...
  ngOnInit() {
    ...
    this.extraCards.push(new card('Order from Template', '100-200 words','template'));
    this.extraCards.push(new card('Order via Spreadsheets', '100-200 words','spreadsheet'));
  }
}
